...
import com.waldo121.pongstats.data.local.dao.PlayerDao
...
@Database(entities = [SingleMatchRecordEntity::class, DoubleMatchRecordEntity::class, PlayerEntity::class], version = 3)
